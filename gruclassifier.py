...
class GRUClassifier(SequenceClassifier):
    def __init__(self,train_X, train_Y, test_X, test_Y, no_of_epochs,learning_rate,no_of_feats,sentence_length,embedding_dim):
        super(GRUClassifier,self).__init__(train_X, train_Y, test_X, test_Y,no_of_epochs,learning_rate,no_of_feats,sentence_length,embedding_dim)
        self.classifier.add(GRU(100))
