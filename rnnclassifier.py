# -*- coding: utf-8 -*-
"""
Created on Thu Nov 16 02:39:25 2017
...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 16 02:38:03 2017
...
class RNNClassifier(SequenceClassifier):
    def __init__(self,train_X, train_Y, test_X, test_Y, no_of_epochs,learning_rate,no_of_feats,sentence_length,embedding_dim):
        super(RNNClassifier,self).__init__(train_X, train_Y, test_X, test_Y,no_of_epochs,learning_rate,no_of_feats,sentence_length,embedding_dim)
        self.classifier.add(SimpleRNN(100))
        self.classifier.add(Dense(1, activation='sigmoid'))
        adam_optimizer = optimizers.Adam(lr=self.leanrningRate)
